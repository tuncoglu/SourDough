 ...
 *
 * Data sources:
 *   - Water company published hardness reports
...
export type HardnessEntry = [number, string, string];

const UK_POSTCODE_HARDNESS: Record<string, HardnessEntry> = {
...
export function lookupUkPostcodeHardness(postcode: string): HardnessEntry {
  if (!postcode) {
