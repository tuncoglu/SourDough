...
export const VEG_CATEGORIES: { key: VegCategory; label: string }[] = [
  ...
  { key: 'pepper', label: '🌶️ Peppers & Chillies' },
...
export const VEGETABLES: VegEntry[] = [
  ...
  },
  {
    ...
    firmness: 'firm',
    typicalWeight: 150,
    notes: '10,000–23,000 SHU — hotter than jalapeño with a cleaner, grassier flavour. Excellent fermented whole in brine. Stocked by Waitrose, Ocado & M&S.',
  },
  {
    id: 'red-chilli',
    name: 'Red Chilli',
    ...
    firmness: 'firm',
    typicalWeight: 150,
    notes: 'The everyday long red chilli (10,000–25,000 SHU, cayenne/Fresno type) — the backbone of most fermented hot sauces. Sold loose in every supermarket.',
  },
  {
    id: 'green-finger-chilli',
    name: 'Green Finger Chilli',
    emoji: '🌶️',
    category: 'pepper',
    waterContentPct: 88,
    typicalBrineSaltPct: 3.0,
    ...
    firmness: 'firm',
    typicalWeight: 150,
    notes: 'The thin green chilli sold as "green chillies" or "finger chillies" (5,000–25,000 SHU). Sweeter and grassier than red — great in Indian-style pickles and mixed ferments.',
  },
  {
    id: 'birds-eye',
    ...
    firmness: 'medium',
    typicalWeight: 50,
    notes: "Thai bird's eye — 50,000–100,000 SHU, seriously hot. Sold fresh in Tesco, Waitrose and Asian grocers. A few go a long way in a sauce. WEAR GLOVES.",
    researchNote: 'Capsaicinoids (the heat compounds) survive lacto-fermentation — fermented chillies keep their fire. Some studies report a slight mellowing of pungency over long ferments, but the tang comes from the LAB, not from lost heat.',
  },
  {
    id: 'scotch-bonnet',
    name: 'Scotch Bonnet',
    ...
    firmness: 'medium',
    typicalWeight: 100,
    notes: "The Caribbean classic — 100,000–350,000 SHU with a fruity, apricot-like aroma. Stocked by Sainsbury's, Tesco, Asda & Waitrose. Essential for jerk marinades and fruity hot sauces. WEAR GLOVES.",
  },
  {
    id: 'padron',
    name: 'Padrón Pepper',
    ...
    firmness: 'medium',
    typicalWeight: 200,
    notes: "Spanish frying pepper — mostly mild (0–2,500 SHU) but roughly 1 in 10 packs a surprise kick. Sold by Tesco, Sainsbury's & Waitrose. Classic blistered in oil with flaky salt.",
  },
  {
    id: 'bell-pepper',
    name: 'Bell Pepper',
